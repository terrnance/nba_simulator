...
public class NBAFileReadWrite  {
	...
	//if they have been updated by the user, their position and if they are
	//an all star talent.
	public static void readFile(String directory_given, ArrayList<Team> given_teamcounter, ArrayList<Player> given_players)throws IOException {
		File directory = new File(directory_given);
