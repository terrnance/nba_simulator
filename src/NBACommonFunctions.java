...
public class NBACommonFunctions{
	...
	//Lists all the teams in a particular conference
	public static void showTeams(ArrayList<Team> given_team_arraylist,String conference_given) {
		for (int i=0;i<given_team_arraylist.size();i++) {
			if (given_team_arraylist.get(i).getConference().equals(conference_given)) {
				System.out.println(i+" "+given_team_arraylist.get(i).getTeamName());
			}
		}
		System.out.println("Which "+conference_given+" Team");
	}
